...
function Questions() {
    return (
        <div className="Questions">
            <div className="margQa">
                <div className="container text-center ">
                    <HeaderChapter
                        title="Frequently asked questions"
                        text="Quickly build an effective pricing table for your potential customers with this
                        Bootstrap
                    ...
                    <div className="container">
                        ...
                        <div className="accordion marg" id="accordionExample">
                            <div className="card">
